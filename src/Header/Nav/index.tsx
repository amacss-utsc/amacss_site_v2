...
export const HeaderNav: React.FC<{ header: HeaderType, toggle: boolean, setToggle: Function, user: User }> = ({ header, toggle, setToggle, user }) => {
  ...
  return (
    <nav 
      ...
      <div className='flex flex-col gap-6 grow md:flex-row md:gap-10 max-md:text-right max-md:font-extrabold max-md:text-4xl'>
        {(toggle && pathname !== '/') &&
