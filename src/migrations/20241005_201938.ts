...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "sub_teams_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "sub_teams_rels" ADD CONSTRAINT "sub_teams_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."sub_teams"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "sub_teams_rels" ADD CONSTRAINT "sub_teams_rels_team_members_fk" FOREIGN KEY ("team_members_id") REFERENCES "public"."team_members"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "sub_teams_rels_order_idx" ON "sub_teams_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "sub_teams_rels_parent_idx" ON "sub_teams_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "sub_teams_rels_path_idx" ON "sub_teams_rels" USING btree ("path");
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "users";
  DROP TABLE "sub_team_types";
  DROP TABLE "team_members";
  DROP TABLE "teams";
  DROP TABLE "teams_rels";
  DROP TABLE "sub_teams";
  DROP TABLE "sub_teams_rels";
